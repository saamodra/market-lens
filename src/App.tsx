...
import { BarChart3, AlertTriangle, Lightbulb, Copy, Search, Filter } from 'lucide-react';
...
import { StockbitScreener } from './components/StockbitScreener';
...
type TabType = 'analyzer' | 'screener';
...
function App() {
  ...
  const handleStockFromScreener = async (symbol: string) => {
    // Switch to analyzer tab and search for the stock
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      {/* Recent Searches - Sticky below header - Only show in analyzer tab */}
      {activeTab === 'analyzer' && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'screener' && (
          <StockbitScreener onSelectStock={handleStockFromScreener} />
        )}
      </main>
    </div>
  );
